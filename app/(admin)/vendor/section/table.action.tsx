...
const TableAction: React.FC<IProps> = ({
    ...
    const handleDetail = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
        e.preventDefault()
        onDetail()
    }
    ...
    return (
        <Wrapper>
            <ButtonDetail href='#' onClick={handleDetail}>
...
const ButtonDetail = styled.a`
    ...
    border-radius: 4px;
    color: whitesmoke;
    background-color: ${ColorScheme.primaryTint.tint20};
    transition: all ease-in-out 200ms;
